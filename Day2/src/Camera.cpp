...
void Camera::filmView_random(const unsigned int &p_x, const unsigned int &p_y, const double &r_x, const double &r_y, Ray &out_ray) const {
    const auto pixelLocalPos = film.pixelLocalPosition_random(p_x, p_y, r_x, r_y);
